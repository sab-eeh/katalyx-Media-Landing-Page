    ...
    <section id="about" className="bg-gray-50 py-20">
      <div className="container mx-auto px-4 md:px-8 space-y-20">
        ...
        <div>
          ...
          >
            <img
              src="/Images/Don.jpg" // <-- Replace with actual image path
              alt="Don Agrahari"
              className="w-32 h-32 mx-auto mb-4 rounded-full object-cover shadow-lg"
            />
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">
          ...
          >
            <p>
              I’m Don Agrahari, Head Director here at Katalyx Media. My job? Making sure
              every project we take on delivers real results for our clients — high-quality
              jobs at prices that make sense. I handle complete service delivery, which
              means I’m involved in everything from strategy to making sure the final
              results actually hit the mark.
            </p>
            <p>
              I’ve worked with a ton of remodelers and construction companies, which has
              given me a clear picture of what works, what doesn’t, and how to avoid the
              headaches that slow growth. I like to keep things fast-moving, focused on
              strategy, and always relationship-driven — because I believe success is built
              on trust just as much as it is on smart marketing.
            </p>
            <p>
              Outside of work, you’ll probably find me playing basketball, following
              sports, geeking out over the latest tech, or getting competitive in a game.
              That drive to win? I bring it into every campaign we run.
            </p>
            <p>
              At Katalyx Media, my goal is simple: help our clients stand out, land more of
              the right jobs, and keep growing — one success story at a time.
            </p>
          </motion.div>
        </div>
